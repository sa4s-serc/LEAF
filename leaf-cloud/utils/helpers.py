...
import time
import numpy as np
from typing import Dict, List, Any, Optional, Union, Callable, TypeVar, Generator
...
def log_section(section_name: str) -> Generator[None, None, None]:
    ...
    try:
        ...
        end_time = time.time()
        logger.info(f"Completed {section_name} in {end_time - start_time:.2f} seconds")


# ===== ERROR HANDLING =====

class CloudModelError(Exception):
    """Base exception for LEAF-Cloud model errors."""
    pass


class ConfigurationError(CloudModelError):
    """Exception raised for configuration errors."""
    pass


class ValidationError(CloudModelError):
    """Exception raised for validation errors."""
    pass


class ResourceError(CloudModelError):
    """Exception raised for resource-related errors."""
    pass


def safe_execute(func: Callable[..., T], default_value: R, 
                 error_msg: str = "Operation failed", 
                 log_level: str = "ERROR") -> Union[T, R]:
    """
...
def load_yaml_file(file_path: str) -> Dict:
    ...
    Raises:
        ConfigurationError: If file doesn't exist or isn't valid YAML
    """
    try:
...
def load_json_file(file_path: str) -> Dict:
    ...
    Raises:
        ConfigurationError: If file doesn't exist or isn't valid JSON
    """
    try:
        with open(file_path, 'r') as f:
            return json.load(f)
